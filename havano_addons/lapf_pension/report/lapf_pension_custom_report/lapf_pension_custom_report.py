...
def get_columns():
    return [
        ...
        {"label": "Salary Component", "fieldname": "salary_component", "fieldtype": "Link", "options": "Salary Component", "width": 140},
        ...
        {"label": "Amount Employer", "fieldname": "amount_employer", "fieldtype": "Currency", "width": 130},
...
def get_data(filters):
    ...
    # Query to get LAPF Pension records with all fields
    lapf_entries = frappe.db.sql(
        """
        SELECT 
            employee_id,
            employee_name,
...
def add_totals_row(data):
    """Add a totals row at the bottom with sums of all amount fields"""
    total_amount_employee = 0
    total_amount_employer = 0
    total_total_amount = 0
    
    for row in data:
        total_amount_employee += flt(row.get('amount_employee', 0))
        total_amount_employer += flt(row.get('amount_employer', 0))
    ...
    totals_row = {
        ...
        "amount_employer": total_amount_employer,
